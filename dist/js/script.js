...
new Vue({
    ...
    data: function data() {
        return {
            ...
            //---------------Added---------------//
            list_reports: [{ id: 10, name: 'Еженедельный отчет WEEK', indicators: ['Портфель', 'RN', 'RL', 'VAS', 'Cloud', 'ioT', 'Системная интеграция', 'Привлечение', 'Развитие'], aggregation: ['РФ', 'Кластеры'], available: [true, true, false, true], detail_level: 'Регион', update_date: '', update_type: 'Кумулятивное', update_period: 'Неделя', main_user: 'Манукян Виктория', dash: '', report_format: 'Электронная таблица', period: 'Неделя', business: 'B2B', iclass: 'fa fa-bolt fa-3x', description: 'Оперативный отчет с основными показателями мобильного и фиксированного бизнеса', basic_folder: '12.Еженедельный_отчет', file_name: 'Week_КЦ', year: '', month: '', file_extension: '.xlsb', file_prefix: '', file_postfix: ['_РФ', '_Растущий', '_Сильный', '_Лидер', '_Эффективный'], rating: 10, online: 'Offline', fa_color: '#555', reg_delimiter: '_', transparent: 0 }, { id: 11, name: 'Mобильный бизнес BOPOS', indicators: ['Доходы', 'База', 'Трафик'], aggregation: ['РФ', 'Кластеры'], available: [true, true, false, true], detail_level: 'Регион', update_date: '', update_type: 'Кумулятивное', update_period: 'Месяц', main_user: 'Гладков Владимир', dash: '', report_format: 'Электронная таблица', period: 'Месяц', business: 'B2B', iclass: 'fa fa-mobile fa-3x', description: 'Отчет содержит основные показатели мобильного бизнеса: выручка, база, трафик', basic_folder: '02.Мобильный_Бизнес', file_name: 'Мобильный бизнес (BOPOS)', year: '', month: '', file_extension: '.xlsb', file_prefix: '', file_postfix: ['_РОССИЯ', '_РЕГИОНЫ РОСТА', '_СИЛЬНЫЙ', '_ЛИДЕР', '_ЭФФЕКТИВНЫЙ'], rating: 10, online: 'Offline', fa_color: '#555', reg_delimiter: '_', transparent: 0 }, { id: 12, name: 'Mобильный бизнес DFIN', indicators: ['Доходы', 'База', 'Трафик', 'm2m', 'Активация'], aggregation: ['РФ', 'Кластеры'], available: [true, true, false, true], detail_level: 'Регион', update_date: '', update_type: 'Кумулятивное', update_period: 'Месяц', main_user: 'Гладков Владимир', dash: '', report_format: 'Электронная таблица', period: 'Месяц', business: 'B2B', iclass: 'fa fa-mobile fa-3x', description: 'Отчет содержит основные показатели мобильного бизнеса: выручка, база, трафик', basic_folder: '02.Мобильный_Бизнес', file_name: 'Мобильный бизнес (DFIN)', year: '', month: '', file_prefix: '', file_extension: '.xlsb', file_postfix: ['_РОССИЯ', '_РЕГИОНЫ РОСТА', '_СИЛЬНЫЙ', '_ЛИДЕР', '_ЭФФЕКТИВНЫЙ'], rating: 10, online: 'Offline', fa_color: '#555', reg_delimiter: '_', transparent: 0 }, { id: 13, name: 'Фиксированный бизнec FIB', indicators: ['Доходы', 'Услуги', 'База'], aggregation: ['РФ', 'Кластеры'], available: [true, true, false, true], detail_level: 'Регион', update_date: '', update_type: 'Кумулятивное', update_period: 'Месяц', main_user: 'Гладков Владимир', dash: '', report_format: 'Электронная таблица', period: 'Месяц', business: 'B2B', iclass: 'fa fa-phone fa-3x', description: 'Отчет содержит основные показатели фиксированного бизнеса: выручка, база, трафик', basic_folder: '03.Фиксированный_Бизнес', file_name: 'FIX_FIB', year: '', month: '', file_extension: '.xlsb', file_prefix: '03.', file_postfix: ['_РОССИЯ', '_РЕГИОНЫ РОСТА', '_СИЛЬНЫЙ', '_ЛИДЕР', '_ЭФФЕКТИВНЫЙ'], rating: 10, online: 'Offline', fa_color: '#555', reg_delimiter: '_', transparent: 0 }, { id: 8, name: 'Еженедельный MOB (Детальный)', indicators: ['Портфель', 'RN', 'RL'], aggregation: ['Территории'], available: [false, false, true, false], detail_level: 'Сотрудник', update_date: 'now', update_type: 'Версионное', update_period: 'Неделя', main_user: 'Моторико Андрей', dash: '', report_format: 'Электронная таблица', period: 'Неделя', business: 'B2B', iclass: 'fa fa-mobile-phone fa-3x', description: 'Отчет с основными бизнес-показателями мобильного бизнеса B2B с детализацией до каналов продаж, отделов и сотрудников', basic_folder: 'WD', file_name: 'WD', year: '_2018', month: '04', file_extension: '.xlsb', file_prefix: '', file_postfix: ['', '', '', '', '', '_ Тер_КРУПНЫЕ', '_ Тер_ЛИДЕР', '_ Тер_РОСТА', '_ Тер_СИЛЬНЫЙ', '_ Тер_ТОП', '_ Тер_ЭФФЕКТИВНЫЙ'], rating: 3, online: 'Offline', fa_color: '#555', reg_delimiter: '_', transparent: 0 }, { id: 9, name: 'Еженедельный FIX (Детальный)', indicators: ['Портфель', 'RN'], aggregation: ['Территории'], available: [false, false, true, false], detail_level: 'Сотрудник', update_date: 'now', update_type: 'Версионное', update_period: 'Неделя', main_user: 'Моторико Андрей', dash: '', report_format: 'Электронная таблица', period: 'Неделя', business: 'B2B', iclass: 'fa fa-phone fa-3x', description: 'Отчет с основными бизнес-показателями фиксированого бизнеса B2B с детализацией до каналов продаж, отделов и сотрудников', basic_folder: 'WD', file_name: 'WD_FIX', year: '_2018', month: '02', file_extension: '.xlsb', file_prefix: '', file_postfix: ['', '', '', '', '', '_Тер_КРУПНЫЕ', '_Тер_ЛИДЕР', '_Тер_РОСТА', '_Тер_СИЛЬНЫЙ', '_Тер_ТОП', '_Тер_ЭФФЕКТИВНЫЙ'], rating: 3, online: 'Offline', fa_color: '#555', reg_delimiter: '_', transparent: 0 }, { id: 14, name: 'Power Perfomance', indicators: ['OIBDA', 'Capex', 'OPEX', 'Рейтинг', 'Доходы', 'CDR', '3m База', '3m Отток', '1m База', '7D', 'Активации', 'RN', 'Миграции', 'm2m', 'Cloud', 'IoT', 'Системная интеграция', 'SAT', 'Базовые Станции', 'VLR'], aggregation: ['РФ', 'Кластеры'], available: [true, true, true, true], detail_level: 'Регион', update_date: 'now', update_type: 'Кумулятивное', update_period: 'Месяц', main_user: 'Моторико Андрей', dash: '', report_format: 'Онлайн отчет', period: 'Месяц', business: 'Смешанное', iclass: 'fa fa-tachometer fa-3x', description: 'Онлайн отчет по основными финансовыми и маркетинговыми показателями компании с выделением направлений B2B, B2C, СИ и драйверов бизнеса', basic_folder: '03.Фиксированный_Бизнес', file_name: 'FIX_FIB', year: '', month: '', file_extension: '.xlsb', file_prefix: '', file_postfix: ['_РОССИЯ', '_РЕГИОНЫ РОСТА', '_СИЛЬНЫЙ', '_ЛИДЕР', '_ЭФФЕКТИВНЫЙ'], rating: 10, online: 'Online', fa_color: '#555', reg_delimiter: '_', transparent: 0 }, { id: 7, name: 'Эффективность продаж B2B', indicators: ['Эффективность'], aggregation: ['РФ'], available: [true, false, false, false], detail_level: 'Сотрудник', update_date: 'now', update_type: 'Кумулятивнoe', update_period: 'Квартал', main_user: 'Тараканов Александр', dash: '', report_format: 'Электронная таблица', period: 'Квартал', business: 'B2B', iclass: 'fa fa-line-chart fa-3x', description: 'Отчет эффективности сотрудников продаж B2B', basic_folder: '31. Эффективность сотурдников продаж', file_name: 'Эффективность v3', year: '', month: '', file_extension: '.xlsx', file_prefix: '', file_postfix: 0, rating: 3, online: 'Offline', fa_color: '#555', reg_delimiter: '_', transparent: 0 }, { id: 0, name: 'ИНН и Контракты', indicators: ['Абоненты', 'Контракты', 'ИНН'], aggregation: ['РФ', 'Кластеры', 'Регионы'], available: [true, true, false, true], detail_level: 'Регион', update_date: 'now', update_type: 'Кумулятивное', update_period: 'Месяц', main_user: 'Моторико Андрей', dash: '', report_format: 'Электронная таблица', period: 'Месяц', business: 'B2B', iclass: 'fa fa-users fa-3x', description: 'Отчет B2B, который содержит абонентскую базу(ПО), контракты, ИНН мобильного и фиксированного бизнеса в разрезе сегменов', basic_folder: '09.ИНН', file_name: 'con_inn_Report', year: '', month: '', file_extension: '.xlsm', file_prefix: '', file_postfix: 0, rating: 10, online: 'Offline', fa_color: '#555', reg_delimiter: '_', transparent: 0 }, { id: 1, name: 'Миграции B2B', indicators: ['Миграции'], aggregation: ['РФ', 'Регионы'], available: [true, false, false, true], detail_level: 'Регион', update_date: 'now', update_type: 'Кумулятивное', update_period: 'Месяц', main_user: 'Иванова Светлана Николаевна', dash: '', report_format: 'Электронная таблица', period: 'Месяц', business: 'B2B', iclass: 'fa fa-exchange fa-3x', description: 'Отчет по миграциям B2B между сегментами массового и корпоративного рынка в доходах и абонентах', basic_folder: '11.Миграции', file_name: 'Migration_report', year: '', month: '', file_extension: '.xlsx', file_prefix: '', file_postfix: 0, rating: 10, online: 'Offline', fa_color: '#555', reg_delimiter: '_', transparent: 0 }, { id: 2, name: 'Модель RN и RL', indicators: ['RN', 'RL'], aggregation: ['РФ', 'Кластеры', 'Регионы'], available: [true, true, false, true], detail_level: 'Регион', update_date: 'now', update_type: 'Кумулятивнoe', update_period: 'Месяц', main_user: 'Моторико Андрей', dash: '', report_format: 'Электронная таблица', period: 'Месяц', business: 'B2B', iclass: 'fa fa-area-chart fa-3x', description: 'Отчет содержит динамику новых доходов (RN) и упущенных доходов (RL) в разрезе терифных планов, сегментов и подсегментов B2B', basic_folder: '06.RN_RL_model', file_name: 'RN_Model', year: '_2018', month: '', file_extension: '.xlsb', file_prefix: '06.', file_postfix: [' РФ', '_Растущий', '_Сильный', '_Лидер', '_Эффективный'], rating: 8, online: 'Offline', fa_color: '#555', reg_delimiter: '_', transparent: 0 }, { id: 3, name: 'MNP B2B', indicators: ['MNP'], aggregation: ['РФ', 'Кластеры', 'Регионы'], available: [true, true, false, true], detail_level: 'Регион', update_date: 'now', update_type: 'Кумулятивнoe', update_period: 'Месяц', main_user: 'Моторико Андрей', dash: '', report_format: 'Электронная таблица', period: 'Месяц', business: 'B2B', iclass: 'fa fa-random fa-3x', description: 'Отчет показывает отток и приток абонентов и доходов B2B в результате MNP (Смена оператора с сохранением номера)', basic_folder: '15.MNP', file_name: 'MNP_B2B', year: '_2018', month: '', file_extension: '.xlsb', file_prefix: '', file_postfix: 0, rating: 4, online: 'Offline', fa_color: '#555', reg_delimiter: '_', transparent: 0 }, { id: 4, name: 'MNP B2B (Детальный)', indicators: ['MNP'], aggregation: ['РФ', 'Кластеры', 'Регионы'], available: [true, true, false, true], detail_level: 'Регион', update_date: 'now', update_type: 'Кумулятивнoe', update_period: 'Месяц', main_user: 'Моторико Андрей', dash: '', report_format: 'Выгрузка', period: 'Месяц', business: 'B2B', iclass: 'fa fa-search-plus fa-3x', description: 'Детальная выгрузка показывает отток и приток абонентов и доходов B2B в результате MNP (Смена оператора с сохранением номера)', basic_folder: '15.MNP', file_name: 'MNP_B2B_DETAL', year: '', month: '', file_extension: '.xlsb', file_prefix: '', file_postfix: ['', '_Кластер_Регионы роста', '_Кластер_Сильный', '_Кластер_Лидер', '_Кластер_Эффективный'], rating: 7, online: 'Offline', fa_color: '#555', reg_delimiter: '_', transparent: 0 }, { id: 5, name: 'Дебиторская задолжность', indicators: ['Дебиторская задолжность'], aggregation: ['РФ', 'Кластеры', 'Регионы'], available: [true, true, false, true], detail_level: 'Регион', update_date: 'now', update_type: 'Версионное', update_period: 'Месяц', main_user: 'Моторико Андрей', dash: '', report_format: 'Электронная таблица', period: 'Месяц', business: 'B2B', iclass: 'fa fa-thumb-tack fa-3x', description: 'Динамика и структура дебиторской задолжности в сегментах корпоративного рынка для мобильного и фиксированного бизнеса', basic_folder: '17.ДЗ', file_name: 'DEBT', year: '_2018', month: '03', file_extension: '.xlsx', file_prefix: '', file_postfix: 0, rating: 3, online: 'Offline', fa_color: '#555', reg_delimiter: '_', transparent: 0 }, { id: 6, name: 'Абонентское оборудование', indicators: ['Оборудование'], aggregation: ['Регионы'], available: [false, false, false, true], detail_level: 'Регион', update_date: 'now', update_type: 'Кумулятивнoe', update_period: 'Месяц', main_user: 'Моторико Андрей', dash: '', report_format: 'Электронная таблица', period: 'Месяц', business: 'B2B', iclass: 'fa fa-fax fa-3x', description: 'Распределение доходов, абонентской базы B2B и B2C по оборудованию, стандарту связи, OS', basic_folder: '27.Абонентское_оборудование', file_name: 'АО', year: '', month: '', file_extension: '.xlsb', file_prefix: '', file_postfix: 1, rating: 3, online: 'Offline', fa_color: '#555', reg_delimiter: '_', transparent: 0 }, { id: 7, name: 'Эффективность продаж B2B', indicators: ['Эффективность'], aggregation: ['РФ'], available: [true, false, false, false], detail_level: 'Сотрудник', update_date: 'now', update_type: 'Кумулятивнoe', update_period: 'Квартал', main_user: 'Тараканов Александр', dash: '', report_format: 'Электронная таблица', period: 'Квартал', business: 'B2B', iclass: 'fa fa-line-chart fa-3x', description: 'Отчет эффективности сотрудников продаж B2B', basic_folder: '31. Эффективность сотурдников продаж', file_name: 'Эффективность v3', year: '', month: '', file_extension: '.xlsx', file_prefix: '', file_postfix: 0, rating: 3, online: 'Offline', fa_color: '#555', reg_delimiter: '_', transparent: 0 }, { id: 15, name: 'Отчет по VAS-услугам', indicators: ['VAS'], aggregation: ['Регионы'], available: [false, false, false, true], detail_level: 'Регион', update_date: 'now', update_type: 'Кумулятивнoe', update_period: 'Неделя', main_user: 'Шевченко Наталья', dash: '', report_format: 'Электронная таблица', period: 'Месяц', business: 'B2B', iclass: 'fa fa-plus-square fa-3x', description: 'Региональный отчет с портфелем, базой и контрактами VAS', basic_folder: '07.VAS', file_name: 'VAS', year: '', month: '', file_extension: '.xlsb', file_prefix: '', file_postfix: ['_РОССИЯ', '_РЕГИОНЫ РОСТА', '_СИЛЬНЫЙ', '_ЛИДЕР', '_ЭФФЕКТИВНЫЙ'], rating: 3, online: 'Offline', fa_color: '#555', reg_delimiter: ' ', transparent: 0 }],
        ...
        OpenReport: function OpenReport(rep_id) {
            ...
            if (reg === null) {
                ...
                if (this.list_reports[rep_id].online === 'Offline') {
                    ...
                    domen = 'http://mtsdash.ru:8088/superset/dashboard/power_performance';
                }
